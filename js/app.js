...
//Generar un objeto como busqueda
const datosBusqueda = {
  marca : '',
  year : '',
  minimo : '',
...
year.addEventListener('change', (e) => {
  datosBusqueda.year = parseInt(e.target.value); //Datos de formularios siempre vienen como string y se debe convertir
  filtrarAuto();
});
...
//Filtra en base a la busqueda  FILTER para filtrar datos
